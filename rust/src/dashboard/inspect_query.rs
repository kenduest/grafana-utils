...
//!
//! This module owns the normalized per-target context used by inspect report assembly:
//! callers provide the panel, target, query text, and resolved datasource type, and the
//! dispatch layer returns the stable `QueryAnalysis` shape that the report and governance
//! builders consume.
use regex::Regex;
...
use super::prompt::datasource_type_alias;
