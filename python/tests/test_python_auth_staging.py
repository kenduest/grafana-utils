...
MODULE_PATH = PYTHON_ROOT / "grafana_utils" / "auth_staging.py"
...
class AuthStagingTests(unittest.TestCase):
    ...
    def test_auth_staging_resolve_auth_headers_prefers_explicit_basic_auth_over_env_token(
        self,
    ):
        headers, auth_mode = auth_staging.resolve_auth_headers(
            username="ops",
    ...
    def test_auth_staging_resolve_auth_headers_rejects_explicit_and_prompt_token_together(
        self,
    ):
        with self.assertRaises(auth_staging.AuthConfigError):
            auth_staging.resolve_auth_headers(
    ...
    def test_auth_staging_format_cli_auth_error_message_rewrites_basic_auth_requirement(
        self,
    ):
    ...
    def test_auth_staging_resolve_auth_from_namespace_supports_fallback_auth_attrs(
        self,
    ):
        args = argparse.Namespace(
            api_token=None,
