...
MODULE_PATH = PYTHON_ROOT / "grafana_utils" / "sync_preflight_workbench.py"
...
class SyncPreflightWorkbenchTests(unittest.TestCase):
    ...
    def test_sync_preflight_build_sync_preflight_document_reports_missing_plugin_and_alert_blocks(
        self,
    ):
        ...
        self.assertEqual(
            checks[("dashboard-datasource-name", "cpu-main->Prometheus Main")][
                "status"
            ],
            "missing",
        )
