...
class FolderPathMatchTests(unittest.TestCase):
    def test_dashboard_folder_path_match_resolve_source_dashboard_folder_path_uses_inventory_record(
        self,
    ):
    ...
    def test_dashboard_folder_path_match_resolve_source_dashboard_folder_path_falls_back_to_file_layout(
        self,
    ):
        with tempfile.TemporaryDirectory() as tmpdir:
            import_dir = Path(tmpdir)
    ...
    def test_dashboard_folder_path_match_resolve_source_dashboard_folder_path_defaults_root_to_general(
        self,
    ):
        with tempfile.TemporaryDirectory() as tmpdir:
            import_dir = Path(tmpdir)
    ...
    def test_dashboard_folder_path_match_resolve_existing_dashboard_folder_path_returns_general_for_builtin(
        self,
    ):
    ...
    def test_dashboard_folder_path_match_resolve_existing_dashboard_folder_path_builds_nested_live_path(
        self,
    ):
        client = FakeFolderPathClient(
            dashboards={
    ...
    def test_dashboard_folder_path_match_build_folder_path_match_result_accepts_missing_destination(
        self,
    ):
    ...
    def test_dashboard_folder_path_match_build_folder_path_match_result_reports_exact_match(
        self,
    ):
        result = folder_path_match.build_folder_path_match_result(
            source_folder_path="Platform / Infra",
    ...
    def test_dashboard_folder_path_match_build_folder_path_match_result_reports_mismatch(
        self,
    ):
        result = folder_path_match.build_folder_path_match_result(
            source_folder_path="Platform / Infra",
    ...
    def test_dashboard_folder_path_match_build_folder_path_match_result_reports_unknown_destination_path(
        self,
    ):
        result = folder_path_match.build_folder_path_match_result(
            source_folder_path="Platform / Infra",
    ...
    def test_dashboard_folder_path_match_apply_folder_path_guard_to_action_rewrites_only_updates(
        self,
    ):
        mismatch = {
            "matches": False,
