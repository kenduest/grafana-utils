...
GOVERNANCE_MODULE = (
    PYTHON_ROOT / "grafana_utils" / "dashboards" / "inspection_governance.py"
)
GOVERNANCE_RENDER_MODULE = (
    PYTHON_ROOT / "grafana_utils" / "dashboards" / "inspection_governance_render.py"
)
...
class DashboardInspectionGovernanceTests(unittest.TestCase):
    ...
    def test_dashboard_inspection_governance_governance_modules_parse_as_python39_syntax(
        self,
    ):
        self._assert_parses_as_python39(GOVERNANCE_MODULE)
        self._assert_parses_as_python39(GOVERNANCE_RENDER_MODULE)

    def test_dashboard_inspection_governance_build_export_inspection_governance_document_summarizes_families_and_risks(
        self,
    ):
    ...
    def test_dashboard_inspection_governance_render_export_inspection_governance_tables_renders_sections(
        self,
    ):
        summary_document, report_document = self._build_fixture_documents()
        document = inspection_governance.build_export_inspection_governance_document(
