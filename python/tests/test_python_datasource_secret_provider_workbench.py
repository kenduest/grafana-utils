...
MODULE_PATH = PYTHON_ROOT / "grafana_utils" / "datasource_secret_provider_workbench.py"
...
class DatasourceSecretProviderWorkbenchTests(unittest.TestCase):
    ...
    def test_datasource_secret_provider_collect_provider_references_rejects_opaque_secret_replay(
        self,
    ):
