...
class DashboardPermissionWorkbenchTests(unittest.TestCase):
    ...
    def test_dashboard_permission_build_permission_export_document_normalizes_subjects_and_levels(
        self,
    ):
    ...
    def test_dashboard_permission_build_permission_diff_document_reports_missing_changed_and_extra(
        self,
    ):
    ...
    def test_dashboard_permission_render_permission_export_text_renders_summary_and_rows(
        self,
    ):
        document = permission_workbench.build_permission_export_document(
            "dashboard",
    ...
    def test_dashboard_permission_build_permission_preflight_document_reports_missing_subjects(
        self,
    ):
    ...
    def test_dashboard_permission_build_permission_promotion_document_summarizes_drift(
        self,
    ):
        expected = permission_workbench.build_permission_export_document(
            "dashboard",
    ...
    def test_dashboard_permission_render_permission_preflight_text_renders_summary_and_rows(
        self,
    ):
        export_document = permission_workbench.build_permission_export_document(
            "folder",
    ...
    def test_dashboard_permission_build_permission_bundle_document_summarizes_resources(
        self,
    ):
    ...
    def test_dashboard_permission_build_permission_bundle_diff_document_summarizes_resource_drift(
        self,
    ):
    ...
    def test_dashboard_permission_render_permission_bundle_text_renders_summary_and_resources(
        self,
    ):
        document = permission_workbench.build_permission_bundle_document(
            self.build_bundle_resources()
    ...
    def test_dashboard_permission_build_permission_remap_document_summarizes_uid_title_and_path_rewrites(
        self,
    ):
    ...
    def test_dashboard_permission_render_permission_remap_text_renders_summary_and_rows(
        self,
    ):
        bundle = permission_workbench.build_permission_bundle_document(
            self.build_bundle_resources()
