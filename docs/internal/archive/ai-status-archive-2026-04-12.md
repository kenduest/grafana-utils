...
- State: Done
- Scope: `rust/src/{cli.rs,cli_dispatch.rs,bin/grafana-util.rs,cli_help/routing.rs,cli_rust_tests.rs}`, `rust/src/commands/dashboard/{mod.rs,command_runner.rs}`, `rust/src/{datasource.rs,datasource_runtime.rs,datasource_browse_support.rs}`, `rust/src/{alert_cli_defs.rs,alert_help_texts.rs,datasource_cli_defs.rs,datasource_help_texts.rs,sync/mod.rs,sync/help_texts.rs}`
...
- State: Done
- Scope: `rust/src/cli/mod.rs`, `rust/src/cli/help/mod.rs`, `rust/src/commands/dashboard/help.rs`, `rust/src/cli/rust_tests.rs`
...
- State: Done
- Scope: `AGENTS.md`, `rust/src/cli/help/mod.rs`, `rust/src/cli/help_examples.rs`, `rust/src/common/help/styles.rs`, `rust/src/cli/rust_tests.rs`
...
- State: Done
- Scope: `rust/src/{bin/grafana-util.rs,cli_help_examples.rs,cli_rust_tests.rs}`, `rust/src/commands/dashboard/help.rs`, `scripts/check_ai_workflow.py`, `README*.md`, `docs/landing/*`, `docs/user-guide/{en,zh-TW}/*`, `docs/commands/{en,zh-TW}/*`, generated docs as needed
...
- State: Done
- Scope: `rust/src/{cli.rs,cli_help.rs,cli_help_examples.rs,profile_cli_help.rs,project_status_command.rs,overview.rs}`, `rust/src/commands/sync/*`, `docs/commands/{en,zh-TW}/*`, `docs/user-guide/{en,zh-TW}/*`, `schemas/{manifests,help}/*`, generated `docs/man/*` and `docs/html/*`
...
- State: In Progress
- Scope: `rust/src/{cli.rs,cli_help.rs,cli_help_examples.rs,cli_rust_tests.rs,alert.rs}`, `rust/src/commands/access/{cli_defs.rs,access_user_cli.rs,access_service_account_cli.rs}`, `docs/commands/{en,zh-TW}/{index,dashboard,alert}.md`, `docs/internal/{ai-status.md,ai-changes.md}`
...
- State: Done
- Scope: `rust/src/commands/access/{render.rs,access_cli_rust_tests.rs,access_runtime_org_rust_tests.rs}`, `docs/commands/{en,zh-TW}/access-user.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/browse_support.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/{cli_defs_shared.rs,dashboard_runtime.rs}`, `rust/src/commands/alert/cli/mod.rs`, `rust/src/commands/access/{access_cli_shared.rs,access_cli_runtime.rs}`, `rust/src/{profile_config.rs,project_status_command.rs,project_status_support.rs}`, `docs/user-guide/{en,zh-TW}/getting-started.md`, generated man/html, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/access/access_user_cli.rs`, `rust/src/commands/access/cli_defs.rs`, `rust/src/commands/access/browse_support.rs`, `rust/src/commands/access/user_browse.rs`, `rust/src/commands/access/user_browse_input.rs`, `rust/src/commands/access/user_browse_render.rs`, `rust/src/commands/access/team_browse_input.rs`, `rust/src/commands/access/team_browse_render.rs`, `rust/src/commands/access/user.rs`, `rust/src/commands/access/mod.rs`, `rust/src/commands/access/access_cli_shared.rs`, `rust/src/commands/access/access_cli_rust_tests.rs`, `docs/commands/en/access-user.md`, `docs/commands/en/access-team.md`, `docs/commands/zh-TW/access-user.md`, `docs/commands/zh-TW/access-team.md`, `docs/user-guide/en/access.md`, `docs/user-guide/zh-TW/access.md`, generated man/html, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/browse_actions.rs`, `rust/src/commands/dashboard/browse_input.rs`, `rust/src/commands/dashboard/browse_render.rs`, `rust/src/commands/dashboard/browse_state.rs`, `rust/src/commands/dashboard/edit_external.rs`, `rust/src/commands/dashboard/cli_defs_command*.rs`, `rust/src/commands/dashboard/dashboard_browse_workflow_rust_tests.rs`, `rust/src/commands/dashboard/dashboard_cli_parser_help_rust_tests.rs`, `docs/commands/en/dashboard-edit-live.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/*`, `rust/src/commands/access/*`, `rust/src/datasource*`, `rust/src/alert*`, `rust/src/snapshot*`, `rust/src/cli*.rs`, `docs/commands/**/*`, `docs/user-guide/**/*`, `README.md`, `README.zh-TW.md`, generated man/html, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/Cargo.toml`, `rust/src/commands/config/profile/secret_store.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`, `docs/internal/ai-learnings.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/cli_defs_command.rs`, `rust/src/commands/dashboard/history.rs`, `rust/src/commands/dashboard/history_cli_rust_tests.rs`, `rust/src/commands/dashboard/dashboard_cli_parser_help_rust_tests.rs`, `docs/commands/en/dashboard-history.md`, `docs/commands/zh-TW/dashboard-history.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/config/profile/secret_store.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/config/profile/secret_store.rs`, `rust/src/commands/config/profile/runtime.rs`, `rust/src/commands/config/profile/tests.rs`, `rust/Cargo.toml`, `docs/commands/en/profile.md`, `docs/commands/zh-TW/profile.md`, `docs/user-guide/en/reference.md`, `docs/user-guide/zh-TW/reference.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/status/live.rs`, `rust/src/grafana/api/project_status_live.rs`, `rust/src/commands/alert/tests/mod.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/grafana/api/alert_live.rs`, `rust/src/grafana/api/alerting.rs`, `rust/src/commands/alert/runtime_support.rs`, `rust/src/commands/alert/tests/mod.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/status/live.rs`, `rust/src/grafana/api/project_status_live.rs`, `rust/src/commands/access/live_project_status.rs`, `rust/src/commands/dashboard/live_project_status.rs`, `rust/src/grafana/api/access.rs`, `rust/src/commands/datasource/mod.rs`, `rust/src/commands/datasource/import_export.rs`, `rust/src/commands/datasource/import/support.rs`, `rust/src/grafana/api/datasource.rs`, `rust/src/grafana/api/tests.rs`, `rust/src/grafana/api/connection.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/grafana/api/sync_live.rs`, `rust/src/grafana/api/sync_live_read.rs`, `rust/src/grafana/api/sync_live_apply.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/datasource/project_status/live.rs`, `rust/src/commands/datasource/project_status/live_analysis.rs`, `rust/src/grafana/api/datasource_live_project_status.rs`
...
- State: Done
- Scope: `rust/src/grafana/api/dashboard.rs`, `rust/src/grafana/api/datasource.rs`, `rust/src/grafana/api/alerting.rs`, `rust/src/grafana/api/sync_live.rs`, `rust/src/grafana/api/tests.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/cli_defs.rs`, `rust/src/commands/dashboard/dashboard_runtime.rs`, `rust/src/commands/dashboard/list.rs`, `rust/src/commands/dashboard/export.rs`, `rust/src/commands/dashboard/mod.rs`, `rust/src/commands/datasource/mod.rs`, `rust/src/commands/datasource/import_export.rs`, `rust/src/commands/datasource/import/routed.rs`, `rust/src/grafana/api/tests.rs`
...
- State: Done
- Scope: `rust/src/commands/resource/mod.rs`, `rust/src/cli/mod.rs`, `rust/src/cli/rust_tests.rs`, `rust/src/commands/dashboard/serve.rs`, `rust/src/commands/dashboard/edit_live.rs`, `rust/src/commands/dashboard/cli_defs_command.rs`, `rust/src/commands/dashboard/dashboard_cli_parser_help_rust_tests.rs`, `rust/src/commands/sync/plan_builder.rs`, `rust/src/commands/sync/staged_documents_render.rs`, `rust/src/commands/sync/rust_tests.rs`, `docs/commands/en/*.md`, `docs/commands/zh-TW/*.md`, `docs/user-guide/en/dashboard.md`, `docs/user-guide/zh-TW/dashboard.md`, `docs/user-guide/en/reference.md`, `docs/user-guide/zh-TW/reference.md`, generated man/html, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/list.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/inspect_live.rs`, `rust/src/grafana/api/dashboard.rs`, `rust/src/grafana/api/tests.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/grafana/api/dashboard.rs`, `rust/src/grafana/api/datasource.rs`, `rust/src/grafana/api/tests.rs`, `rust/src/commands/dashboard/live.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/grafana/api/**`, `rust/src/lib.rs`, `rust/src/commands/dashboard/dashboard_runtime.rs`, `rust/src/commands/alert/mod.rs`, `rust/src/commands/alert/client.rs`, `rust/src/commands/alert/cli/mod.rs`, `rust/src/commands/access/access_cli_runtime.rs`, `rust/src/commands/status/support.rs`, `rust/src/commands/sync/live.rs`, focused Rust tests, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/sync/guided.rs`, focused Rust tests in `rust/src/commands/sync/guided.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/files.rs`, `rust/src/commands/dashboard/authoring.rs`, `rust/src/commands/dashboard/dashboard_export_import_inventory_rust_tests.rs`, `rust/src/commands/dashboard/dashboard_authoring_rust_tests.rs`, `scripts/test-rust-live-grafana.sh`, `README.md`, `README.zh-TW.md`, `docs/commands/en/dashboard-publish.md`, `docs/commands/zh-TW/dashboard-publish.md`, `docs/user-guide/en/dashboard.md`, `docs/user-guide/zh-TW/dashboard.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `.github/workflows/ci.yml`, `Makefile`, `docs/DEVELOPER.md`, `TODO.md`, `rust/src/commands/dashboard/authoring.rs`, `rust/src/commands/dashboard/dashboard_authoring_rust_tests.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/common/mod.rs`, `rust/src/common/rust_tests.rs`, `rust/src/commands/dashboard/inspect_paths.rs`, `rust/src/commands/dashboard/vars.rs`, `rust/src/commands/dashboard/topology.rs`, `rust/src/commands/dashboard/validate.rs`, `rust/src/commands/sync/bundle_exec_rust_tests.rs`, `docs/internal/maintainer-quickstart.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/sync/guided.rs`, `rust/src/commands/sync/live_fetch.rs`, `rust/src/commands/sync/live_rust_tests.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/authoring.rs`, `rust/src/commands/dashboard/cli_defs_command.rs`, `rust/src/commands/dashboard/dashboard_authoring_rust_tests.rs`, `rust/src/commands/dashboard/dashboard_cli_parser_help_rust_tests.rs`, `docs/commands/en/dashboard-patch-file.md`, `docs/commands/en/dashboard-review.md`, `docs/commands/en/dashboard-publish.md`, `docs/commands/zh-TW/dashboard-patch-file.md`, `docs/commands/zh-TW/dashboard-review.md`, `docs/commands/zh-TW/dashboard-publish.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/prompt.rs`, `rust/src/commands/dashboard/raw_to_prompt_rust_tests.rs`, `scripts/compare_prompt_semantics.py`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/cli/mod.rs`, `rust/src/cli/help/mod.rs`, `rust/src/lib.rs`, `rust/src/commands/sync/apply_contract.rs`, `rust/src/commands/sync/apply_builder.rs`, `rust/src/commands/sync/live.rs`, `rust/src/commands/sync/live_apply.rs`, `rust/src/commands/sync/workbench.rs`, `rust/src/commands/alert/client.rs`, `rust/src/grafana/http.rs`, `rust/src/commands/dashboard/export.rs`, `rust/src/commands/dashboard/live.rs`, `rust/src/commands/sync/preflight.rs`, `rust/src/commands/sync/rust_tests.rs`, `rust/src/commands/sync/live_rust_tests.rs`, `docs/DEVELOPER.md`, `docs/overview-rust.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/cli_defs_command.rs`, `rust/src/commands/dashboard/cli_defs_shared.rs`, `rust/src/commands/dashboard/raw_to_prompt.rs`, `rust/src/commands/dashboard/raw_to_prompt_rust_tests.rs`, `rust/src/commands/dashboard/mod.rs`, `rust/src/commands/dashboard/test_support.rs`, `rust/src/cli/mod.rs`, `rust/src/cli/help/mod.rs`, `rust/src/cli/help_examples.rs`, `rust/src/cli/rust_tests.rs`, `rust/src/commands/dashboard/dashboard_cli_parser_help_rust_tests.rs`, `README.md`, `README.zh-TW.md`, `docs/commands/en/*.md`, `docs/commands/zh-TW/*.md`, `docs/user-guide/en/dashboard.md`, `docs/user-guide/en/reference.md`, `docs/user-guide/zh-TW/dashboard.md`, `docs/user-guide/zh-TW/reference.md`, `docs/man/*.1`, `docs/html/**`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Blocked
- Scope: `rust/src/commands/alert/cli/mod.rs`, `rust/src/commands/alert/list.rs`, `rust/src/commands/alert/tests/mod.rs`
...
- State: Done
- Scope: `rust/src/commands/config/profile/config.rs`, `rust/src/commands/config/profile/mod.rs`, `rust/src/cli/mod.rs`, `rust/src/cli/help_examples.rs`, `rust/src/commands/dashboard/cli_defs_shared.rs`, `rust/src/commands/dashboard/dashboard_runtime.rs`, `rust/src/commands/access/access_cli_shared.rs`, `rust/src/commands/access/access_cli_runtime.rs`, `rust/src/commands/alert/cli/mod.rs`, `rust/src/commands/status/mod.rs`, `rust/src/commands/status/support.rs`, `rust/src/commands/dashboard/authoring.rs`, `rust/src/commands/dashboard/cli_defs_command.rs`, `rust/src/commands/dashboard/dashboard_cli_parser_help_rust_tests.rs`, `rust/src/commands/dashboard/authoring_rust_tests.rs`, `rust/src/commands/dashboard/mod.rs`, `rust/src/cli/rust_tests.rs`, `docs/user-guide.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: In Progress
- Scope: `rust/src/commands/sync/mod.rs`, `rust/src/commands/sync/guided.rs`, `rust/src/commands/sync/cli.rs`, `rust/src/commands/sync/*_rust_tests.rs`, `rust/src/cli/help/mod.rs`, `rust/src/cli/help_examples.rs`, `rust/src/cli/rust_tests.rs`, `rust/src/commands/dashboard/mod.rs`, `rust/src/commands/dashboard/history_cli_rust_tests.rs`, `docs/commands/en/change.md`, `docs/commands/en/index.md`, `docs/commands/zh-TW/index.md`, `docs/user-guide/en/change-overview-status.md`, `docs/user-guide/en/role-sre-ops.md`, `docs/user-guide/zh-TW/role-sre-ops.md`, `README.md`, `README.zh-TW.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/import_lookup.rs`, `rust/src/commands/dashboard/live.rs`, `rust/src/grafana/api/dashboard.rs`, `rust/src/grafana/api/tests.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/import_apply.rs`, `rust/src/commands/dashboard/import_validation.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/grafana/api/access.rs`, `rust/src/grafana/api/tests.rs`, `rust/src/commands/datasource/import/support.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/import_apply.rs`, `rust/src/commands/dashboard/import_lookup.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/import_dry_run.rs`, `rust/src/commands/dashboard/import_interactive_review.rs`, `rust/src/commands/dashboard/import_apply.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/import_interactive.rs`, `rust/src/commands/dashboard/import_interactive_render.rs`, `rust/src/commands/dashboard/import_interactive_state.rs`, `rust/src/commands/dashboard/import_apply.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/import_apply.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/commands/dashboard/cli_defs_inspect.rs`, `rust/src/commands/dashboard/cli_defs_command.rs`, `rust/src/commands/dashboard/analysis_source.rs`, `rust/src/commands/dashboard/topology.rs`, `rust/src/commands/dashboard/governance_gate.rs`, `rust/src/commands/dashboard/topology_impact_rust_tests.rs`, `docs/commands/en/dashboard-topology.md`, `docs/commands/zh-TW/dashboard-topology.md`, `docs/commands/en/dashboard-governance-gate.md`, `docs/commands/zh-TW/dashboard-governance-gate.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `fixtures/shared_diff_contract_cases.json`, `fixtures/shared_diff_golden_cases.json`, `rust/src/cli/rust_tests.rs`, `rust/src/commands/alert/tests/mod.rs`, `rust/src/commands/dashboard/export_diff_rust_tests.rs`, `rust/src/commands/datasource/tests/diff.rs`, `docs/user-guide/en/diff-json-contract.md`, `docs/user-guide/zh-TW/diff-json-contract.md`, `docs/DEVELOPER.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/cli/mod.rs`, `rust/src/cli/help/mod.rs`, `rust/src/cli/rust_tests.rs`, `rust/src/commands/dashboard/cli_defs_command_history.rs`, `rust/src/commands/dashboard/dashboard_cli_parser_help_rust_tests.rs`, `schemas/manifests/dashboard-history/contracts.json`, `schemas/manifests/dashboard-history/routes.json`, `schemas/jsonschema/dashboard-history/dashboard-history-diff.schema.json`, `schemas/help/dashboard-history/diff.help.txt`, `docs/commands/en/dashboard-history.md`, `docs/commands/zh-TW/dashboard-history.md`, `docs/user-guide/en/reference.md`, `docs/user-guide/zh-TW/reference.md`, `fixtures/machine_schema_golden_cases.json`
...
- State: Done
- Scope: `rust/src/cli/help/mod.rs`, `rust/src/cli/rust_tests.rs`, `rust/src/commands/dashboard/help.rs`, `rust/src/commands/access/access_user_cli.rs`, `rust/src/commands/access/cli_defs.rs`, `rust/src/commands/access/access_service_account_cli.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/cli/mod.rs`, `rust/src/cli/help/mod.rs`, `rust/src/cli/rust_tests.rs`, `rust/src/commands/dashboard/help.rs`, `rust/src/commands/config/profile/help.rs`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
...
- State: Done
- Scope: `rust/src/cli/help/mod.rs`, `rust/src/cli/help/{grouped.rs,grouped_specs.rs,routing.rs,schema.rs,legacy.rs}`, `rust/src/cli/help_examples.rs`, `rust/src/common/help/styles.rs`, `rust/src/cli/rust_tests.rs`, `AGENTS.md`, `docs/internal/ai-status.md`, `docs/internal/ai-changes.md`
- Baseline: `rust/src/cli/help/mod.rs` mixed grouped command entrypoint specs, renderer code, contextual clap routing, schema-help routing, color handling, full-help examples, and legacy command hints in one large file. Tests also asserted several fixed headings and raw ANSI escape strings, making normal output text edits too noisy.
...
- State: Done
- Scope: `rust/src/commands/sync/{mod.rs,cli_args.rs,dispatch.rs,output.rs,cli.rs}`, `rust/src/commands/alert/cli/*`, `rust/src/commands/alert/support/*`, `rust/src/commands/dashboard/{browse_input*,history*}`, `rust/src/commands/datasource/{export,import}/*`, `rust/audit-home.edited.json`, `rust/smoke-prom-only.edited.json`, and `rust/x`.
...
## 2026-04-12 - Split CLI help architecture by responsibility
- State: Done
- Scope: `rust/src/cli/help/mod.rs`, `rust/src/cli/help/{grouped.rs,grouped_specs.rs,routing.rs,schema.rs,legacy.rs}`, CLI help tests, and AI workflow notes.
...
- State: Done
- Scope: `rust/src/commands/access/org.rs`, `rust/src/commands/access/org_workflows.rs`, access Rust tests, and AI trace docs.
...
- State: Done
- Scope: `rust/src/bin/grafana-util.rs`, `rust/src/cli/mod.rs`, `rust/src/cli/help/mod.rs`, `rust/src/cli/help_examples.rs`, `rust/src/cli/help/grouped_specs.rs`, `rust/src/cli/rust_tests.rs`, `scripts/check_docs_surface.py`, `scripts/contracts/command-surface.json`, command-reference docs, and generated-doc source contracts.
